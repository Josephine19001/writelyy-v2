...
// --- Icons ---
import { MicAiIcon } from "@analytics/components/tiptap-icons/mic-ai-icon"
import { AiSparklesIcon } from "@analytics/components/tiptap-icons/ai-sparkles-icon"
import { CheckAiIcon } from "@analytics/components/tiptap-icons/check-ai-icon"
import { TextExtendIcon } from "@analytics/components/tiptap-icons/text-extend-icon"
import { TextReduceIcon } from "@analytics/components/tiptap-icons/text-reduce-icon"
import { Simplify2Icon } from "@analytics/components/tiptap-icons/simplify-2-icon"
import { SmileAiIcon } from "@analytics/components/tiptap-icons/smile-ai-icon"
import { CompleteSentenceIcon } from "@analytics/components/tiptap-icons/complete-sentence-icon"
import { SummarizeTextIcon } from "@analytics/components/tiptap-icons/summarize-text-icon"
import { LanguagesIcon } from "@analytics/components/tiptap-icons/languages-icon"
...
import {
  SUPPORTED_LANGUAGES,
  SUPPORTED_TONES,
} from "@analytics/components/tiptap-ui/ai-menu"
...
import { Card, CardBody } from "@analytics/components/tiptap-ui-primitive/card"
