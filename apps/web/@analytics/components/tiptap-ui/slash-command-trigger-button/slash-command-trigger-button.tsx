...
// --- Tiptap UI ---
import type { UseSlashCommandTriggerConfig } from "@analytics/components/tiptap-ui/slash-command-trigger-button"
import {
  SLASH_COMMAND_TRIGGER_SHORTCUT_KEY,
  useSlashCommandTrigger,
} from "@analytics/components/tiptap-ui/slash-command-trigger-button"
