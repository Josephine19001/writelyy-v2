	...
	return (
		<DropdownMenu modal={false}>
			<DropdownMenuTrigger asChild>
				<button
					type="button"
					className="flex cursor-pointer w-full items-center justify-between gap-2 rounded-lg outline-hidden focus-visible:ring-2 focus-visible:ring-primary md:w-[100%+1rem] md:px-2  md:hover:bg-primary/5"
			...
			<DropdownMenuContent align="end">
				...
				<DropdownMenuItem asChild>
					<a href="https://writelyy.dev/docs/nextjs">
