...
import { useFloatingElement } from "@shared/tiptap/hooks/use-floating-element";
// --- Hooks ---
...
import { isValidPosition } from "@shared/tiptap/lib/tiptap-utils";
	...
	(
		...
		React.useEffect(() => {
			...
			return () => {
				...
				if (updateOnScroll) {
					editor.view.root.removeEventListener(
						"scroll",
						updateIfOpen,
						true,
					);
