...
// Icons
import { GripVerticalIcon } from "@shared/tiptap/components/tiptap-icons/grip-vertical-icon";
...
import { TextColorSmallIcon } from "@shared/tiptap/components/tiptap-icons/text-color-small-icon";
import {
	AskAiShortcutBadge,
	useAiAsk,
} from "@shared/tiptap/components/tiptap-ui/ai-ask-button";
import { useBlockquote } from "@shared/tiptap/components/tiptap-ui/blockquote-button";
import { useCodeBlock } from "@shared/tiptap/components/tiptap-ui/code-block-button";
import {
	HIGHLIGHT_COLORS,
	useColorHighlight,
} from "@shared/tiptap/components/tiptap-ui/color-highlight-button";
import {
	TEXT_COLORS,
	useColorText,
} from "@shared/tiptap/components/tiptap-ui/color-text-button";
import type { RecentColor } from "@shared/tiptap/components/tiptap-ui/color-text-popover";
import {
	getColorByValue,
	useRecentColors,
} from "@shared/tiptap/components/tiptap-ui/color-text-popover";
import {
	CopyAnchorLinkShortcutBadge,
	useCopyAnchorLink,
} from "@shared/tiptap/components/tiptap-ui/copy-anchor-link-button";
import {
...
import {
	...
	useDeleteNode,
} from "@shared/tiptap/components/tiptap-ui/delete-node-button";
import {
	DuplicateShortcutBadge,
	useDuplicate,
} from "@shared/tiptap/components/tiptap-ui/duplicate-button";
import { useHeading } from "@shared/tiptap/components/tiptap-ui/heading-button";
// Tiptap UI
import { useImageDownload } from "@shared/tiptap/components/tiptap-ui/image-download-button";
import { useList } from "@shared/tiptap/components/tiptap-ui/list-button";
import { useResetAllFormatting } from "@shared/tiptap/components/tiptap-ui/reset-all-formatting-button";
import { SlashCommandTriggerButton } from "@shared/tiptap/components/tiptap-ui/slash-command-trigger-button";
import { useText } from "@shared/tiptap/components/tiptap-ui/text-button";
...
import { selectNodeAndHideFloating } from "@shared/tiptap/hooks/use-floating-toolbar-visibility";
...
} from "@shared/tiptap/lib/tiptap-collab-utils";
...
const SubMenuTrigger: React.FC<{
	...
	>
		<MenuContent portal>
			<ComboboxList style={{ width: "fit-content" }}>
				{children}
			</ComboboxList>
		</MenuContent>
	</Menu>
