...
import { HeadingFiveIcon } from "@shared/tiptap/components/tiptap-icons/heading-five-icon";
import { HeadingFourIcon } from "@shared/tiptap/components/tiptap-icons/heading-four-icon";
// --- Icons ---
import { HeadingOneIcon } from "@shared/tiptap/components/tiptap-icons/heading-one-icon";
import { HeadingSixIcon } from "@shared/tiptap/components/tiptap-icons/heading-six-icon";
