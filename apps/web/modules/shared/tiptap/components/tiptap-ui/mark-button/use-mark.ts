...
// --- Icons ---
import { BoldIcon } from "@shared/tiptap/components/tiptap-icons/bold-icon";
import { Code2Icon } from "@shared/tiptap/components/tiptap-icons/code2-icon";
import { ItalicIcon } from "@shared/tiptap/components/tiptap-icons/italic-icon";
import { StrikeIcon } from "@shared/tiptap/components/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@shared/tiptap/components/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@shared/tiptap/components/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@shared/tiptap/components/tiptap-icons/underline-icon";
// --- Hooks ---
